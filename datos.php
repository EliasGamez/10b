...
<section class="home-section">
    ...
    <section class="form-register">
                ...
                <input class="controls" type="text" value="<?php echo $mostrar['Grado']; ?>" readonly>
                <label for="">Carrera</label>
                <input class="controls" type="text" value="<?php echo $mostrar['Carreras']; ?>" readonly>
                <label for="">Nivel</label>
                <input class="controls" type="text" value="<?php echo $mostrar['Nivel']; ?>" readonly>
